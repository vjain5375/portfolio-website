  ...
  return (
    <div ref={sectionRef} id={id} className="relative py-24">
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        <div className="absolute left-[10px] md:left-[calc(50%-1.5px)] top-0 bottom-0 w-[3px]">
          {/* Background line */}
            ...
            return (
              <div key={index} className="relative pl-14 md:pl-0">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="absolute left-[10px] md:left-[calc(50%-10px)] top-1/2 -translate-y-1/2 z-20"
                >
                  <motion.div
                    animate={
                      isHovered
